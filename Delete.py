...
def answer_button(answer, left_m, right_m):
    ...
    button.setStyleSheet(
        "*{border: 4px solid '#BC006C'; color: 'white'; font-family: 'Shanti'; font-size: 16px; border-radius: 25px; padding:15px 0px; margin-left:" + str(
            left_m) + "px; margin-right:" + str(right_m) + "px; margin-top:20px;} *:hover{background:'#BC006C';}"
    )
